...
export interface Order {
  ...
  date: Date;
  items: OrderItem[];
  subtotal?: number; // Opcional para compatibilidad con pedidos antiguos
  additionalFees?: number; // Opcional para compatibilidad con pedidos antiguos
  total: number;
  status: 'pending' | 'preparing' | 'ready' | 'delivered' | 'cancelled';
  orderType?: 'pickup' | 'delivery'; // Opcional para compatibilidad con pedidos antiguos
  deliveryAddress?: string;
  deliveryNeighborhood?: string;
  deliveryPhone?: string;
  deliveryInstructions?: string;
  paymentMethod?: string; // Opcional para compatibilidad con pedidos antiguos
  paymentInfo?: any;
  estimatedPrepTime?: number; // Tiempo estimado de preparación en minutos
  estimatedDeliveryTime?: Date; // Tiempo estimado de entrega
  statusHistory?: OrderStatusUpdate[]; // Historial de cambios de estado
